...
pub fn emit_ownership_proposed(
    env: &Env,
    old_admin: &Address,
...
pub fn emit_ownership_accepted(
    env: &Env,
    old_admin: &Address,
    new_admin: &Address,
) {
...
pub fn emit_ownership_cancelled(
    env: &Env,
    admin: &Address,
