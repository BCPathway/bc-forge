...
//! | `11` | `InvalidWasmHash` | `require_valid_wasm_hash` for an unregistered/malformed hash |
//! | `12` | `NotProposer` | `cancel_proposal` when `caller` did not submit the proposal |
//! | `13` | `ProposalNotCancellable` | `cancel_proposal` on a `Cancelled` or `Expired` proposal |
//!
//! ## Event Emissions
//!
